...
public class UserServiceImpl implements UserService {
    ...
    // final 로 만들면 Alt + Enter 로 constructor 에서 받아내기
    ...
    public int register(User user) {
        ...
        // password 는 PasswordEncoder 로 암호화 하여 저장해야함
        userRepository.save(user); // 회원저장, id 값 받아온다.
    ...
    public List<Authority> selectAuthoritiesById(Long id) {
        ...
        return authorityRepository.findByUser(user); // 특정 유저의 권한 읽어옴
    }
}
